...
const Search = ({ setTestUser }) => {

    const user = new User('Santino', 'Stimoli', 'santinostimoli@gmail.com', 45238867,
        [
    ...
    return (
        <div className='my-10 flex justify-center'>
            ...
            <button onClick={() => setTestUser(user)} className='ml-3 cursor-pointer buscador opacity-90 hover:opacity-100' type={'submit'} >Buscar</button>
        </div>
    );
}
